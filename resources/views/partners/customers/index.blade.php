...
<div class="flex items-center justify-between mb-4">
    ...
    @include('partners.customers.tabs')
        ...
        <button id="defaultModalButton" data-modal-target="create-customer-modal"
...
<div class="relative overflow-x-auto shadow-md sm:rounded-lg mt-5">
                ...
                <form action="#">
                    ...
                    <div class="relative">
                        ...
                        <input type="search" id="default-search" name="search"
                            ...
                            value="{{ request('search') }}" placeholder="Masukan Nama" autocomplete="off">
                        <button type="submit"
    ...
    <div id="alert-3" class="flex p-4 my-4 text-green-800 rounded-lg bg-green-50 dark:bg-gray-800 dark:text-green-400"
        role="alert">
        ...
        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
            ...
            <tbody>
                ...
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                    ...
                    <td class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                        <a href="{{ route('partners.customers.show', $customer->id) }}"
                            class="font-medium text-blue-600 dark:text-blue-500 hover:underline"><span>Detail</span></a>
                    </td>
                </tr>
                @endforeach
            </tbody>
    ...
    @include('partners.customers.print-invoice-batch')
