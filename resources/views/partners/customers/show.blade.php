            ...
            <form action="{{ route('partners.customers.invoice', $customer->id) }}">
                ...
                <div class="grid gap-4 mb-4 sm:grid-row-2">
                    ...
                    <div class="relative max-w">
                        <label for="tgl_invoice" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Periode Tagihan</label>
                        ...
                        <input datepicker datepicker-format="yyyy-mm-dd" type="text" id="tgl_invoice" name="tgl_invoice" autocomplete="off" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Pilih Tanggal">
                    </div>
                </div>
