<aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-60 h-screen pt-20 transition-transform -translate-x-full bg-sidebar border-r border-gray-300 sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700 " aria-label="Sidebar">
    <div class="h-full px-3 pb-4 overflow-y-auto bg-sidebar dark:bg-gray-800">
       <ul class="space-y-2 font-medium">
          <li class="{{ Request::is('admin/dashboard') ? 'bg-menubar dark:bg-purple-700 rounded-lg' : '' }}">
             <a href="{{ route('admin.dashboard.index') }}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-hover dark:hover:bg-purple-800">
          ...
          <li class="{{ Request::is('admin/partners*') ? 'bg-menubar dark:bg-purple-700 rounded-lg' : '' }}">
             <a href="{{ route('admin.partners.index') }}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-hover dark:hover:bg-purple-800">
                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" height="16" width="20" aria-hidden="true" viewBox="0 0 640 512" class="w-6 h-6 text-white transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white">
                ...
                <span class="flex-1 ml-3 text-white whitespace-nowrap">Partner</span>
             </a>
          </li>
       </ul>
    </div>
